...
public class StunClient5389UDP(IPEndPoint server, string serverName, IPEndPoint local, IUdpProxy? proxy = null): STUN.Client.StunClient5389UDP(server, local, proxy), IStunClient5389 {
